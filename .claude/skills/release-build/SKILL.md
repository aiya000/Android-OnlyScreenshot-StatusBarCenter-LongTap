---
name: release-build
description: Build the signed release APK of this OnlyScreenshot app with gradle. Use when the user asks for a production or release build, or before the `release-install` skill.
---
